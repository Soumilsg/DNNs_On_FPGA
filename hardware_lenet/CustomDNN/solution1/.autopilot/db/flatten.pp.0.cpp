...
void flatten(const float X[32][5][5], float Y[(32*5*5)]);
# 3 "flatten.cpp" 2

void flatten(const float X[32][5][5],
                   float Y[(32*5*5)])
{

#pragma HLS INTERFACE mode=ap_memory port=X depth=32*5*5
#pragma HLS INTERFACE mode=ap_memory port=Y depth=(32*5*5)
